import { BarChart3, BrainCircuit, CalendarDays, CheckSquare2, ListChecks, MessageSquareText, NotebookPen, Trash2 } from 'lucide-react'

/** 顶层页面状态集中定义，避免布局组件和 App 各自维护一套字符串。 */
export type View = 'calendar' | 'plans' | 'todos' | 'notes' | 'stats' | 'agent' | 'review' | 'trash' | 'schedule'
