...
class LoginBriefingServiceTest {
    ...
    void formatsAtMostThreeRealtimeNewsItems() {
        List<SearchResult> results = List.of(
                result("热点一", "媒体甲", "10:00", "https://example.com/1"),
    ...
    @Test
    void fallsBackToWebSearchWhenPrimaryNewsSourceFails() {
        AtomicBoolean fallbackCalled = new AtomicBoolean();
        SearchResult fallbackResult = result(
                "回退热点", "公共搜索", "10:00", "https://example.com/fallback");
    ...
    @Test
    void fallsBackToWebSearchWhenPrimaryReturnsNoNews() {
        AtomicBoolean fallbackCalled = new AtomicBoolean();
