...
public final class VisualDeckSender {
    ...
    private final Consumer<String> sentMarker;
    private final BiConsumer<String, String> textRecorder;

    public VisualDeckSender(VisualCardRenderer renderer) {
        this(renderer, ignored -> { }, (userId, text) -> { });
    }

    public VisualDeckSender(VisualCardRenderer renderer, Consumer<String> sentMarker) {
