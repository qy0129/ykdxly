...
public class AiService {
    ...
    public String callQwen(String userMessage) throws Exception {
    ...
    public static boolean isDrawRequest(String text) {
        ...
        return t.contains("生成") && t.contains("图片")
                || t.contains("绘制")
                || t.contains("画一个")
                || t.contains("画一只")
                || t.contains("画一张")
    ...
    public String[] callQwenDraw(String userMessage) throws Exception {
        JsonObject body = new JsonObject();
        body.addProperty("model", Config.MODEL);
    ...
    public String callQwenWithImage(String userMessage, String base64Image) throws Exception {
        JsonObject body = new JsonObject();
    ...
    public byte[] callImageGeneration(String prompt) throws Exception {
